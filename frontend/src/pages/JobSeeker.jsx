...
function JobSeeker() {
  ...
  const handleClearFilters = () => {
    ...
    setSalaryRange('');
    setLocation('');
    getJobs({ variables: { role: '', salaryRange: '', location: '' } }); // Refetch all jobs
  };
      ...
      <div className="max-w-6xl w-full mx-auto p-4">
        ...
        <div className="flex mb-4">
          <button
            ...
            className="bg-blue-500 text-white font-medium py-2 px-4 rounded-lg focus:outline-none hover:bg-blue-600 transition duration-300 ease-in-out active:bg-blue-700 active:border-blue-800"
          >
            Apply Filters
          </button>
          <button
            onClick={handleClearFilters} // Clear filters button
            className="ml-4 bg-gray-500 text-white font-medium py-2 px-4 rounded-lg focus:outline-none hover:bg-gray-600 transition duration-300 ease-in-out active:bg-gray-700 active:border-gray-800"
          >
            Clear Filters
          </button>
        </div>
