...
const typeDefs=gql`
    ...
    type User {
      ...
      extend type Query {
        ...
        applicantsCount(jobId: ID!): Int!  # New field to get the count of applicants
        getJobs(role: String, salaryRange: String, location: String): [Job!]!
        getJobById(id: ID!): Job
        getUserProfile(id: ID!): User
        getApplicants(jobId: ID!): [Application!]!  # New field to get applicants for a specific job
      }
